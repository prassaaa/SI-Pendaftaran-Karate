    ...
    <div class="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden">
        <div class="bg-gradient-to-r from-blue-600 to-indigo-600 px-8 py-6">
            <div class="flex items-center space-x-4">
                ...
                <div>
                    <h1 class="text-2xl font-bold text-white">Tambah Kategori Usia</h1>
                    <p class="text-blue-100">Buat kategori usia baru untuk peserta kejuaraan</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="max-w-4xl">
        <div class="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden">
            <div class="px-8 py-6 border-b border-gray-100">
                ...
                <p class="text-gray-500 mt-1">Lengkapi form di bawah untuk menambahkan kategori usia baru</p>
            </div>

            <div class="p-8">
                <form action="{{ route('admin.master.kategori-usia.store') }}" method="POST" class="space-y-8">
                    @csrf
                    ...
                    <div class="space-y-2">
                        ...
                        <textarea id="deskripsi"
                                  ...
                                  placeholder="Keterangan tambahan tentang kategori usia ini...">{{ old('deskripsi') }}</textarea>
                        @error('deskripsi')
                            <p class="text-red-500 text-sm flex items-center space-x-1">
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/>
