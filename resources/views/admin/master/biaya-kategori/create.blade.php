    ...
    <div class="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden">
        <div class="bg-gradient-to-r from-purple-600 to-indigo-600 px-8 py-6">
            <div class="flex items-center space-x-4">
                ...
                <div>
                    <h1 class="text-2xl font-bold text-white">Tambah Biaya Kategori</h1>
                    <p class="text-purple-100">Atur biaya pendaftaran untuk setiap kategori pertandingan</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="max-w-4xl">
        <div class="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden">
            <div class="px-8 py-6 border-b border-gray-100">
                ...
                <p class="text-gray-500 mt-1">Tentukan biaya untuk setiap kategori pertandingan karate</p>
            </div>

            <div class="p-8">
                <form action="{{ route('admin.master.biaya-kategori.store') }}" method="POST" class="space-y-8">
                    @csrf
                ...
                <div class="bg-white rounded-lg p-4 border border-purple-100">
                    <div class="flex items-center space-x-3">
                        ...
                        <div>
                            ...
                            <div class="text-lg font-bold text-gray-900" id="preview-kumite">Rp 50.000</div>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-lg p-4 border border-purple-100">
                    <div class="flex items-center space-x-3">
                        ...
                        <div>
                            ...
                            <div class="text-lg font-bold text-gray-900" id="preview-kata">Rp 40.000</div>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-lg p-4 border border-purple-100">
                    <div class="flex items-center space-x-3">
                        ...
                        <div>
                            ...
                            <div class="text-lg font-bold text-gray-900" id="preview-beregu">Rp 75.000</div>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="mt-6 p-4 bg-white rounded-lg border border-purple-100">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <div class="text-2xl font-bold text-purple-900" id="preview-total">Rp 240.000</div>
                    </div>
                    <div class="text-right">
                        <div class="text-sm text-gray-500">Biaya terendah</div>
                        <div class="text-lg font-semibold text-green-600" id="preview-minimum">Rp 40.000</div>
                    </div>
                </div>
            </div>
        </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function updateCalculations() {
        ...
        const total = kumite + kata + (beregu * 2); // beregu applies to both kata beregu and kumite beregu
