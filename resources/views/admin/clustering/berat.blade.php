...
@section('title', 'Clustering Berat Badan Peserta')
...
<div class="space-y-6">
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
        <div class="flex items-center justify-between">
            <div>
                <h1 class="text-2xl font-bold text-gray-900">Clustering Berat Badan Peserta</h1>
                <p class="text-gray-600 mt-1">Analisis pengelompokan peserta berdasarkan kategori berat badan</p>
            </div>
            <div class="flex space-x-3">
                <a href="{{ route('admin.clustering') }}" class="inline-flex items-center px-4 py-2 bg-gray-600 text-white rounded-lg hover:bg-gray-700 transition-colors">
                ...
                <div class="relative" x-data="{ open: false }">
                    ...
                    <div x-show="open" @click.away="open = false" x-transition class="absolute right-0 mt-2 w-48 bg-white rounded-lg shadow-lg border border-gray-200 z-10">
                        <a href="{{ route('admin.clustering-berat.export', ['format' => 'excel']) }}"
                        ...
                        <a href="{{ route('admin.clustering-berat.export', ['format' => 'pdf']) }}"
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    <p class="text-sm font-medium text-gray-600">Berat Teringan</p>
                    <p class="text-2xl font-bold text-gray-900">{{ $statistics['min_weight'] }} kg</p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    <p class="text-sm font-medium text-gray-600">Berat Terberat</p>
                    <p class="text-2xl font-bold text-gray-900">{{ $statistics['max_weight'] }} kg</p>
                </div>
            </div>
        </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <!-- Cluster Chart -->
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            <h3 class="text-lg font-semibold text-gray-900 mb-4">Distribusi Cluster Berat Badan</h3>
            <div class="relative">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            <h3 class="text-lg font-semibold text-gray-900 mb-4">Scatter Plot Clustering Berat Badan</h3>
            <div class="relative">
                <canvas id="scatterChart" width="400" height="300"></canvas>
            </div>
            <div class="mt-2 text-xs text-gray-500 text-center">
                Sumbu X: Berat Badan (kg) | Sumbu Y: Umur (tahun)
            </div>
        </div>
    </div>
    ...
    <!-- Cluster Summary -->
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
        <h3 class="text-lg font-semibold text-gray-900 mb-4">Ringkasan Cluster Berat Badan</h3>
            ...
            <div class="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
                <div class="flex items-center">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-gray-600">{{ $cluster['min'] }}-{{ $cluster['max'] > 100 ? '∞' : $cluster['max'] }} kg</p>
                    </div>
                </div>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200">
        <div class="p-6 border-b border-gray-200">
            <h3 class="text-lg font-semibold text-gray-900">Detail Data Cluster Berat Badan</h3>
        </div>

        <div class="p-6">
            <div x-data="{ activeTab: 'Kelas Ringan' }" class="space-y-6">
                <!-- Tab Navigation -->
...
function prepareScatterData() {
    ...
    Object.keys(clusterData).forEach(clusterName => {
        ...
        cluster.peserta.forEach(peserta => {
            scatterPoints.push({
                x: parseFloat(peserta.berat_badan),
                y: peserta.umur_calculated,
                peserta: peserta
            });
        });
...
function refreshData() {
    fetch('{{ route("admin.clustering-berat.data") }}')
